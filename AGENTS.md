...
- Keep the Home page intentionally minimal and action-oriented: a short welcome, one compact summary with no more than two headline metrics, quick navigation actions, and recent activity. Detailed filters, category charts, rankings, and multi-series analytics belong in Analyst rather than Home.
